"""
Django settings for real_time_quotes_consumer project.
...
SECRET_KEY = 'django-insecure-wsai*7b(o72o(=&0l9&skxdyxns7(3)c!exhozga^j-krh0u2u'
...
ROOT_URLCONF = 'real_time_quotes_consumer.urls'
...
WSGI_APPLICATION = 'real_time_quotes_consumer.wsgi.application'
...
ASGI_APPLICATION = 'real_time_quotes_consumer.asgi.application'
