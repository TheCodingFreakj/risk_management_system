...
SECRET_KEY = 'django-insecure-)tw*btiaz$i1z@yy-xzp0a+ngda*tc$mxnj#%3bmdono+oe6eo'
...
ROOT_URLCONF = 'real_time_quotes_producer.urls'
...
WSGI_APPLICATION = 'real_time_quotes_producer.wsgi.application'
...
ASGI_APPLICATION = 'real_time_quotes_producer.asgi.application'
